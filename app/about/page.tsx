            ...
            <div className="relative z-10 pt-32 pb-20 px-6 container mx-auto">
                ...
                <div className="max-w-4xl mx-auto text-center mb-20 space-y-6">
                    ...
                    <p className="text-xl md:text-2xl text-zinc-400 font-light max-w-2xl mx-auto leading-relaxed">
                        Democratizando la información política a través de la inteligencia artificial.
                    </p>
                ...
                <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto text-left">
                    ...
                    <div className="group relative p-8 rounded-3xl bg-zinc-900/30 border border-white/5 backdrop-blur-sm hover:border-[#D91023]/30 transition-all duration-500 hover:shadow-[0_0_30px_rgba(217,16,35,0.1)] hover:-translate-y-1">
                        ...
                        <div className="relative z-10 space-y-4">
                            ...
                            <p className="text-zinc-400 leading-relaxed">
                                En un mar de desinformación y campañas ruidosas, encontrar propuestas reales es difícil. AkllAI simplifica el análisis de planes de gobierno, permitiéndote comparar candidatos objetivamente.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="group relative p-8 rounded-3xl bg-zinc-900/30 border border-white/5 backdrop-blur-sm hover:border-orange-500/30 transition-all duration-500 hover:shadow-[0_0_30px_rgba(249,115,22,0.1)] hover:-translate-y-1">
                        ...
                        <div className="relative z-10 space-y-4">
                            ...
                            <p className="text-zinc-400 leading-relaxed">
                                Utilizamos modelos de lenguaje avanzados para procesar miles de páginas de documentos oficiales, extrayendo los puntos clave, contradicciones y viabilidad de cada propuesta.
                            </p>
                        </div>
                    </div>
                        ...
                        <div className="flex flex-col md:flex-row items-center gap-8">
                            <div className="flex-1 space-y-6">
                                ...
                                <p className="text-lg text-zinc-300 leading-relaxed">
                                    Imaginamos un futuro donde cada ciudadano tenga un asistente personal imparcial que le ayude a navegar la complejidad de la política nacional. AkllAI no te dice por quién votar, te da las herramientas para que tú decidas.
                                </p>
