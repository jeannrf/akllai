...
const StatsCard = ({
    ...
    return (
        ...
        >
            {/* Image Container */}
            <div className={`relative h-72 w-full overflow-hidden rounded-t-xl border-t border-x border-white/10 transition-colors duration-300 group-hover:border-red-600/50 ${isVisible ? 'opacity-100' : 'opacity-0'}`} style={{ transitionDelay: `${delay + 500}ms` }}>
...
export default function RealidadNacional() {
    ...
    return (
        <section className="min-h-screen py-24 relative overflow-hidden flex flex-col justify-center"
            style={{
                background: 'radial-gradient(ellipse at top, #3a0000 0%, #1a0000 40%, #000000 100%)'
            }}
        >
            ...
            <style jsx>{`
                @keyframes twinkle {
                    ...
                    50% { opacity: 0.8; transform: scale(1.2); box-shadow: 0 0 3px #ffffff; }
                }
                .sparkle {
                    position: absolute;
            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                <div className="text-center mb-24 space-y-6">
                    <p className="text-lg md:text-xl text-zinc-300 font-medium tracking-wide font-poppins">
                        Las cifras no mienten: la desinformación elige gobiernos equivocados.
                    </p>
